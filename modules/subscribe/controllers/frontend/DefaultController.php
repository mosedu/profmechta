...
namespace app\modules\subscribe\controllers\frontend;

use Yii;
use app\modules\subscribe\models\Subscribe;
use app\modules\subscribe\models\SubscribeSearch;
...
//    }
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            return $this->refresh();
//            return $this->redirect(['view', 'id' => $model->subscr_id]);
        }
     ...
     * @return mixed
     */
    public function actionNewsubscriber()
    {
        $model = new Subscribe();
        $model->scenario = 'frontentcreate';
